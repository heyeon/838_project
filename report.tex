...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_cpu_server_noswitch.png}
...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_cpu_server_switch.png}
\includegraphics[scale=0.75]{avg_cpu_server_switch.png} \caption{
...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_latency_fifo_sfq.png}
...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_latency_FIFO.png}
...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_latency_tcp.png}
...
\begin{figure}[t] \includegraphics[scale=0.75]{avg_latency_udp.png}
